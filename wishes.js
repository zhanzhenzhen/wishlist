...
(function() {
  ...
  npmWishes.environmentType = (typeof exports !== "undefined" && exports !== null) && ((typeof module !== "undefined" && module !== null ? module.exports : void 0) != null) ? "node" : typeof window !== "undefined" && window !== null ? "browser" : void 0;

  npmWishes.Test = (function() {
      ...
      if (arguments[0] instanceof npmWishes.Test) {
        ...
        normalizeWishlist = (function(_this) {
          return function(raw) {
            ...
            return npmWishes.parseWishlist(combined);
          };
        })(this);
    ...
    Test.prototype.run = function(showsMessage) {
      ...
      this._resetContext();
      if (this.parent != null) {
        this.env = npmWishes.objectClone(this.parent.env);
      }
    ...
    Test.prototype._checkWish = function(wishStr) {
      ...
      interpret = (function(_this) {
        return function(s) {
          npmWishes.parseExpression(s, Object.keys(_this.env)).forEach(function(m, index) {
    ...
    Test.prototype.wish = function(wishlistStr) {
      return npmWishes.parseWishlist(wishlistStr).forEach((function(_this) {
          ...
          if (Array.isArray(actual) && Array.isArray(ruler)) {
            if (ruler.every(function(m, index) {
              if (__indexOf.call(objects, m) >= 0) {
                return npmWishes.objectIs(actual[index], m);
              } else {
            ...
            if (Object.keys(ruler).every(function(m) {
              ...
              if (_ref = ruler[m], __indexOf.call(objects, _ref) >= 0) {
                return npmWishes.objectIs(actual[m], ruler[m]);
              } else {
            ...
            return npmWishes.objectIs(actual, ruler);
          }
        };
      })(this);
      newResult = {
  ...
  npmWishes.objectIs = function(a, b) {
  ...
  npmWishes.objectClone = function(x) {
  ...
  npmWishes.valueToMessage = function(value) {
    var internal, r;
  ...
  npmWishes.parseExpression = function(expStr, envNames) {
  ...
  npmWishes.parseWish = function(wishStr) {
  ...
  npmWishes.parseWishlist = function(wishlistStr) {
  ...
  npmWishes.packageInfo = {
    "name": "wishes",
    "version": "0.1.1",
    "description": "Super natural testing framework.",
    "keywords": ["test", "testing", "unit", "bdd", "tdd", "mocha", "qunit", "karma", "jasmine", "vows", "qunitjs"],
    "author": "Zhenzhen Zhan <zhanzhenzhen@hotmail.com>",
    "homepage": "https://github.com/zhanzhenzhen/wishes",
    "licenses": [
      {
        "type": "MIT",
        "url": "https://github.com/zhanzhenzhen/wishes/blob/master/LICENSE.txt"
      }
    ],
    "repository": {
      "type": "git",
      "url": "https://github.com/zhanzhenzhen/wishes.git"
    },
    "devDependencies": {
      "coffee-script": "1.7.1",
      "uglify-js": "2.4.13"
