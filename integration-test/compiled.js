...
(function() {
  ...
  new Test("root").set(function(v) {
    ...
    return v.obj.unit();
  }, ['  (obj.unit>1)=true']).add(new Test("nested test").add("test 1 in nested test", function() {
    return void 0;
  ...
  }).setWishlist(['var1 is var2', 'var1 isnt var2', 'var3=1'])).addAsync("simple test 2", function(v, t) {
    ...
    return void 0;
  }, "inexistentVariable=inexistentVariable").add(function() {
    return falseFunction(true);
